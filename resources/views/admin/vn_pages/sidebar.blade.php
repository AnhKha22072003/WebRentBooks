            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarOrders" data-bs-toggle="collapse" role="button"
                        ...
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="" class="nav-link" data-key="t-form-select">Lịch sử cho thuê sách</a>
                            </li>
                            <li class="nav-item">
                                <a href="" class="nav-link" data-key="t-form-select">Lịch sử bán sách</a>
                            </li>
                            <li class="nav-item">
                                <a href="" class="nav-link" data-key="t-form-select">Quản lý cho thuê</a>
                            </li>
                        </ul>
                    </div>
                </li>
