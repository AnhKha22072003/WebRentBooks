...
<div class="pagination-wrapper">
    ...
    <div class="col-sm-6 text-right page-result">số sách 
        <span class="fw-semibold">{{$paginator->firstItem()}}</span> trên 
        <span class="fw-semibold">{{$paginator->lastItem()}}</span> tổng số 
