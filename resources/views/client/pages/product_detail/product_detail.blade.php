                        ...
                        <div id="product">
                            ...
                            <div class="product-rightinfo">
                                ...
                                <div class="form-group cart-block" style="display: flex">
                                    ...
                                    <div style="display: flex">
                                        <input type="number" id="quantity-input" name="quantity"
                                            max="{{ $product->quantity }}" value="1" min="1"
                                            data-url="{{ route('client.products.getPrice', ['product' => $product->id]) }}"
                                ...
                                <div class="form-group cart-block" style="display: flex">
                                    ...
                                    <div style="display: flex">
                                        <input style="display: inline-block; width: 180px" id="total-input"
                                            type="text" disabled name="quantity"
                                            value="{{ number_format(calculatePrice($product)) }} đ" size="2"
                                            class="form-control">
                                    </div>
                                </div>
                        ...
                        <div class="content_product_block">
                            <div>
                                <div class="product-tabs" id="custom_tab">
                                    <ul>
                                        <li><a class="first selected" href="#tab-1"
                                                style="display: inline;">Description</a>
                                        </li>
                    ...
                    <div class="tab-pane active" id="tab-description">
                                    ...
                                    @foreach ($product->reviews as $review)
                                        <tr>
                                            ...
                                            <td class="text-right">{{ $review->created_at }}
                                                ...
                                                <form method="POST"
                                                action="{{ route('client.products.deleteReview', ['review' => $review->id]) }}">
                                                @csrf
                                                @method('DELETE')
                                                    <button style="margin-left: 20px" id="delete-btn">Delete</button>
                                                </td>
                                            </form>
                                                @endif
                                            </td>
                            ...
                            <form class="form-horizontal" id="form-review" method="POST">
                                ...
                                <div class="form-group required">
                                    <div class="col-sm-12">
                                        ...
                                        &nbsp;
                                        <input type="radio" name="rating" value="5" id="default-rating"
                                            checked />
                                        &nbsp;Good
                                    </div>
                                </div>
                                ...
                                <div class="buttons clearfix">
                                    <div class="pull-right">
                                        <button type="button" id="button-review"
                                            ...
                                            data-loading-text="Loading..." class="btn btn-primary">Post</button>
                                    </div>
                                </div>
                            </form>
                        @endif
                        <div class="comment--form pd--30-0">
                            ...
                            <div class="comment-respond">
                                ...
                                @auth
                                    <form method="POST" action="{{ route('client.products.postReview') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn-success">Bình luận</button>
                                        </div>
                                    </form>
                                ...
                                @guest
                                    <p class="h4">
                                        ...
                                        <a href="{{ route('signup') }}">Đăng ký</a> để bình luận bài viết
                                    </p>
                                @endguest
                            </div>
