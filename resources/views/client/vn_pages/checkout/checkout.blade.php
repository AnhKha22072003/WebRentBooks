        ...
        <div class="row">
            <div id="content" style="width: 100%; height:100%; padding:20px ;background-color:#FFF; border-radius:5px">
                ...
                @if ($cart->count() > 0)
                    ...
                    <form method="GET" action="{{ route('client.placeOrder') }}">
                        <!-- Các trường khác của form -->
                    @csrf
                        <div class="row" style="margin-top: 20px;">
                            <div class="col-sm-6">
                                <input type="radio" id="pick-up-checkbox" name="ship" value="1">
                                <label for="pick-up-checkbox">Nhận hàng trực tiếp</label>
                                <input type="radio" id="delivery-checkbox" name="ship" value="0">
                                <label for="delivery-checkbox">Giao hàng</label>
                            </div>
                    
                            <div class="col-sm-6" id="delivery-address" style="display: none;">
                                <label for="delivery-address-input">Địa chỉ giao hàng:</label>
                                <input type="text" id="delivery-address-input" class="form-control" name="location">
                            </div>
                        </div>
                        ...
                        <div class="buttons clearfix">
                            <div class="pull-right">
                                <button type="submit" data-url="{{ route('client.placeOrder') }}" class="btn btn-primary" id="order-btn">Đặt hàng</button>
                            </div>
                        </div>
                    </form>
                @else
