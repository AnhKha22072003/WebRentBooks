        ...
        <div class="row">
            <aside id="column-left" class="col-sm-3 hidden-xs">
                <div class="box left-category">
                    <div class="box-heading">LOẠI SÁCH</div>
                            ...
                            @foreach ($categories as $category)
                                <li class="@if ($count >= 10) hidden-categories @endif">
                                    <a class="@if (request()->category === $category->slug) active @endif"
                                        href="{{ route('client.products.vnIndex') }}?category={{ $category->slug }}&keyword={{ request()->keyword ?? '' }}">
                                        <span
                                            style="
                ...
                <div class="box sidebarFilter">
                    ...
                    <form class="filterbox" id="filter-form" method="GET" action="{{ route('client.products.vnIndex') }}">
                        ...
                        <div class="list-group-filter">
                            ...
                            <div class="filter-content">
                                <div class="list-group-item title">Mức Giá</div>
                                <div class="list-group-item">
                    ...
                    <div class="pagination-right">
                        ...
                        <div class="show-wrapper">
                            <div class="col-md-2 text-right show">
                                <label class="control-label" for="input-limit">Hoặc:</label>
                            </div>
                                        ...
                                        <div class="product-details">
                                            <div class="caption">
                                                ...
                                                <p class="price">
                                                    ...
                                                    / {{request()->number_rent_price_days ?? 7}}ngày
